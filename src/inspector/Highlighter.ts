...
export type HighlighterRuleFunction = (
  ...
  context: HighlighterRuleContext,
) => () => void;
...
export class Highlighter {
  ...
  public constructor(inspector: Inspector) {
    ...
    this._rules = [
      ...
      [
        '/meshes/:meshIndex/primitives/:primIndex/targets/:targetIndex',
        highlightGLTFPrimitiveTarget,
      ],
      [
        '/meshes/:meshIndex/primitives/:primIndex/extras/targetNames/:targetIndex',
        highlightGLTFPrimitiveTarget,
      ],
      [
        '/meshes/:meshIndex/extras/targetNames/:targetIndex',
        highlightGLTFMeshTarget,
      ],
      ...
      [
        ...
        highlightVRMLookAtOffset,
      ],
      [
        '/extensions/VRM/firstPerson/meshAnnotations',
        highlightVRMFirstPersonMeshAnnotation,
      ],
      [
        '/extensions/VRM/blendShapeMaster/blendShapeGroups/:index',
        highlightVRM0BlendShapeGroup,
      ],
      [
        '/extensions/VRM/secondaryAnimation/boneGroups/:index',
        highlightVRM0SecondaryAnimationBoneGroup,
      ],
      [
        '/extensions/VRMC_vrm/humanoid/humanBones/:boneName',
        highlightVRM1HumanBone,
      ],
      [
        '/extensions/VRMC_vrm/expressions/preset/:expressionName',
        highlightVRM1Expression,
      ],
      [
        '/extensions/VRMC_vrm/expressions/custom/:expressionName',
        highlightVRM1Expression,
      ],
      [
      ...
      [
        '/extensions/VRMC_vrm/lookAt/offsetFromHeadBone',
        highlightVRMLookAtOffset,
      ],
      [
        '/extensions/VRMC_springBone/springs/:index',
        highlightVRM1SpringBoneSpring,
      ],
    ];
  }
  ...
  public highlight(path: string): (() => void) | undefined {
    ...
    const rule = this._rules.find(([rulePath]) => {
      ...
      if (pathSplit.length !== rulePathSplit.length) {
        return false;
      }
