...
// == element ======================================================================================
export const Meta1Content = ({ meta }: { meta: VRM1Meta }) => {
  return (
    <>
      ...
      <NameValueEntry
        ...
        value={meta.copyrightInformation}
      />
      <NameValueEntry
        name="Contact Information"
        value={meta.contactInformation}
      />
      <NameValueEntry name="References" value={meta.references?.join(', ')} />
      <NameValueEntry
        name="Third Party Licenses"
        value={meta.thirdPartyLicenses}
      />
      ...
      <NameValueEntry
        ...
        value={String(meta.allowExcessivelyViolentUsage)}
      />
      <NameValueEntry
        name="Allow Excessively Sexual Usage"
        value={String(meta.allowExcessivelySexualUsage)}
      />
      <NameValueEntry
        name="Commercial Usage Name"
        value={meta.commercialUsage}
      />
      <NameValueEntry
        name="Allow Political or Religious Usage"
        value={String(meta.allowPoliticalOrReligiousUsage)}
      />
      <NameValueEntry
        name="Allow Antisocial or Hate Usage"
        value={String(meta.allowAntisocialOrHateUsage)}
      />
      <NameValueEntry name="Credit Notation" value={meta.creditNotation} />
      <NameValueEntry
        name="Allow Redistribution"
        value={String(meta.allowRedistribution)}
      />
